try{
      ! function(a, b) {
        ...
        function d(d, g) {
            function h() {
                if (y) {
                    r = b.createElement("canvas"),r.id="pg-canvas", r.className = "pg-canvas", r.style.display = "block", d.insertBefore(r, d.firstChild), s = r.getContext("2d"), i();
            ...
            function i() {
              ...
              r.height = document.getElementById('sidebar').offsetHeight,r.width = d.offsetWidth, s.fillStyle = g.dotColor, s.strokeStyle = g.lineColor, s.lineWidth = g.lineWidth
            }
